...
COUNT (*) AS booth_assignment_per_vendor
...
SUM(customer_purchase.quantity * customer_purchases.cost_to_customer_per_qty) AS amount_spent
FROM customer
INNER JOIN customer_purchasre ON customer.customer_id = customer_purchase.customer_id
...
DROP TABLE IF EXIST new_vendor;
